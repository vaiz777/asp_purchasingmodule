<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="True" CodeBehind="List.aspx.cs" Inherits="ManagementSystem.Purchasing.Material_Request.Project.Price_Request.List" Title="Price List" %>
  ...
  <div style="padding: 10px">
    <div style="border: medium solid #CCCCCC; background-color: White; border-radius: 10px; padding: 15px">
      <div style="font-weight: normal; font-family: 'Trebuchet MS'; font-size: large;">
        <img src="../../../../images/icons/icons8-product-48.png" alt="icons8-time-card-48.png" />&nbsp;List Material Request (Project)
      </div><br />
            ...
            <telerik:RadGrid ID="GridMR" runat="server" AllowPaging="True" 
              ...
              <MasterTableView AutoGenerateColumns="False" DataKeyNames="id" 
                ...
                <Columns>
                  ...
                  <telerik:GridBoundColumn DataField="project_nomor" HeaderText="No Project" 
                    SortExpression="project_nomor" UniqueName="project_nomor" 
                    ItemStyle-HorizontalAlign="Center" >
                    <ItemStyle HorizontalAlign="Center" />
                  </telerik:GridBoundColumn>
