<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="True" CodeBehind="Input.aspx.cs" Inherits="ManagementSystem.Purchasing.Material_Request.Project.Price_Request.Input" Title="Price Input" %>
...
<div style="padding: 10px">
  <div style="border: medium solid #CCCCCC; background-color: White; border-radius: 10px; padding: 15px">
    <div style="font-weight: normal; font-family: 'Trebuchet MS'; font-size: large; ">
      <img src="../../../../images/icons/icons8-product-48.png" alt="icons8-time-card-48.png" />&ensp;Input Harga
    </div><br />
...
<asp:UpdatePanel ID="UpdatePanel5" runat="server">
  ...
  <asp:UpdatePanel ID="PnlSugestiModal" runat="server">
        ...
        <asp:Panel ID="PnlSuggestionsPrice" runat="server"  CssClass="modalPopup" Width="50%" >
          ...
          <div style="padding:10px; text-align:left">
            <telerik:RadGrid ID="GridCekHarga" runat="server" 
              DataSourceID="CekHargaDataSource" GridLines="None" 
              onitemcommand="GridCekHarga_ItemCommand">
    ...
    SelectMethod="GetDataStatusSetHargaByMrId" 
