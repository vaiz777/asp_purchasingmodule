  ...
  public partial class Input : System.Web.UI.Page
  {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      if (!IsPostBack) 
      {
        ...
        {
          HdIdProject.Value = purDataSet.vpur_podetail02[0].project_id.ToString();
          TxtNomorProject.Text = purDataSet.vpur_podetail02[0].project_nomor;
          BtnBrowseProject.Visible = false;
    ...
    protected void GridProject_ItemCommand(object source, GridCommandEventArgs e)
    {
      if (e.CommandName == "RowClick")
      {
        var gridDataItem = (GridDataItem)e.Item;
        ...
        TxtNomorProject.Text = gridDataItem["nomorproject"].Text;
        HdIdProject.Value = gridDataItem["id"].Text;

        PnlViewProjectModalPopupExtender.Hide();
      }
    }
    ...
    protected void BtnCancel_Click(object sender, EventArgs e)
    {
      ...
      try
      {
        ...
        poRow.nomerpo = TglPO.SelectedDate == null ? GetNomerPO(DateTime.Now) : GetNomerPO(TglPO.SelectedDate.Value);
        poRow.tglpo = TglPO.MinDate;
        poRow.type = "P";
        poRow.ppn = 0;
        poRow.ppnval = 0;
        poRow.diskon = 0;
        ...
        {
          if (TglPO.SelectedDate == null) { 
            GeUpdateSeedPO(DateTime.Now);
            CUtils.UpdateSeed("pur_nopo", DateTime.Now.Year, DateTime.Now.Month, DateTime.Now);
          }
          else 
          { 
            GeUpdateSeedPO(TglPO.SelectedDate.Value); 
            CUtils.UpdateSeed("pur_nopo", TglPO.SelectedDate.Value.Year, TglPO.SelectedDate.Value.Month, TglPO.SelectedDate.Value); 
          }
    ...
    protected void BtnSaveAll_Click(object sender, EventArgs e)
    {
      ...
      {
        poRow.id = HdIdPO.Value;
        poRow.nomerpo = GetNomerPO(TglPO.SelectedDate.Value);
        poRow.tglpo = TglPO.SelectedDate.Value;
        poRow.type = "P";
    ...
    {
      PnlViewProjectModalPopupExtender.Show();
    }
