<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="True" CodeBehind="List.aspx.cs" Inherits="ManagementSystem.Purchasing.Material_Request.Project.Purchase_Order.List" Title="List PO" %>
  ...
  <div style="padding: 10px">
    <div style="border: medium solid #CCCCCC; background-color: White; border-radius: 10px; padding: 15px;">
      <div style="font-weight: normal; font-family: 'Trebuchet MS'; font-size: large; ">
        <img src="../../../../images/icons/icons8-product-48.png" alt="icons8-time-card-48.png" />&ensp; Daftar Purchase Order (Project)
      </div><br />
                ...
                <tr>
                  ...
                  <td class="tableFieldHeader" colspan="3">
                    <asp:DropDownList ID="DlistKategoriPencarian" runat="server" onselectedindexchanged="DlistKategoriPencarian_SelectedIndexChanged" AutoPostBack="True">
                      ...
                      <asp:ListItem Value="3">Nama Supplier</asp:ListItem>
                    </asp:DropDownList>
                  </td>
                </tr>
                <tr>
