...
namespace ManagementSystem.Purchasing.Material_Request.Project.Purchase_Order
{
  ...
  {
    //public static string IdProject, IdSupplier, IdMr, jasa_lain, IdPOD;
    //public int harga_jasa;
    //public int ppn, diskon, biaya_lain, subtotal, total, totalA;
    //public double ppnF, subtotalF, diskonF, biaya_lainF, diskonB;
    //public double result;
    //CultureInfo cultures = new CultureInfo("en-SG");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      if (!IsPostBack)
      {
        ...
        if (poTableAdapter.FillById(purDataSet.pur_po, id) > 0) {
          ...
          PgPOHdDiskonVal.Value = Convert.ToDouble(purDataSet.pur_po[0].diskonval).ToString();
          ...
          PgPOHdPPNVal.Value = Convert.ToDouble(purDataSet.pur_po[0].ppnval).ToString();
