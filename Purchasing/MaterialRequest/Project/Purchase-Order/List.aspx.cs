...
namespace ManagementSystem.Purchasing.Material_Request.Project.Purchase_Order
{
  public partial class List : System.Web.UI.Page
  {
    ...
    private void loadGridDefault()
    {
      ...
      PODataSource.SelectParameters.Add("type", "P");
    ...
    protected void cetakLaporan(String idPO)
    {
      ...
      {
        reportViewer.LocalReport.ReportPath = Server.MapPath("~/reports/RptPOA.rdlc");
      }
      else {
        reportViewer.LocalReport.ReportPath = Server.MapPath("~/reports/RptPOB.rdlc");
      }      
