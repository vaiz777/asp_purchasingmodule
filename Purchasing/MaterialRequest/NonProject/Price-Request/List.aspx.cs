...
namespace ManagementSystem.Purchasing.Material_Request.NonProject.Price_Request
{
  public partial class List : System.Web.UI.Page
  {
    ...
    {
      // Title ...
      if (getUnitKerja == "SHIPYARD") { LblTitle.Text = "Daftar Material Request (Non Project)"; }
      else { LblTitle.Text = "Daftar Material Request"; }
    ...
    protected void GridMR_ItemCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
    {
      ...
      if (e.CommandName == "RowClick")
      {
        ...
        LblDepartement.Text = purDataSet.vpur_mr01[0].departement;
        ...
        if (Session["UnitKerja"].ToString() == "SHIPYARD")
        {
    ...
    private void printMR(String note)
    {
      ...
      reportViewer.LocalReport.ReportPath = Server.MapPath("~/reports/RptMRNonProject.rdlc");
      ...
      string pDepartement = purDataSet.vpur_mr01[0].departement;

      _myReportParameters[0] = new ReportParameter("pNoMR", pNoMR);
      _myReportParameters[1] = new ReportParameter("pTglMR", pTglMR);
      _myReportParameters[2] = new ReportParameter("pOperator", pOperator);
      _myReportParameters[3] = new ReportParameter("pRequestor", pRequestor);
      _myReportParameters[4] = new ReportParameter("pDepartement", pDepartement);
      _myReportParameters[5] = new ReportParameter("pReference", pReference);
   ...
   private void SearchGeneral(string kategori, string txtKataKunci)
    {
      if (kategori == "0")
      {
        ...
        MaterialRequestDataSource.SelectParameters.Add("type", "NP");
   ...
   private void SearchByUnitManufacture(string kategori, string txtKataKunci)
   {
     if (kategori == "0")
     {
       MaterialRequestDataSource.SelectMethod = "GetDataManufactureByTypeId";
       MaterialRequestDataSource.SelectParameters.Clear();
       MaterialRequestDataSource.SelectParameters.Add("id", txtKataKunci);
       MaterialRequestDataSource.SelectParameters.Add("type", "NP");
     ...
     {
       MaterialRequestDataSource.SelectMethod = "GetDataManufactureByTypeNoProject";
       MaterialRequestDataSource.SelectParameters.Clear();
       MaterialRequestDataSource.SelectParameters.Add("noproject", txtKataKunci);
       MaterialRequestDataSource.SelectParameters.Add("type", "NP");
     ...
     {
       MaterialRequestDataSource.SelectMethod = "GetDataManufactureByTypeStatus";
       MaterialRequestDataSource.SelectParameters.Clear();
       MaterialRequestDataSource.SelectParameters.Add("status", DlistStatus.SelectedValue);
       MaterialRequestDataSource.SelectParameters.Add("type", "NP");
     ...
     else if (kategori == "3")
     {
       ...
       MaterialRequestDataSource.SelectMethod = "GetDataManufactureByTypeTanggal";
       MaterialRequestDataSource.SelectParameters.Clear();
       MaterialRequestDataSource.SelectParameters.Add("tanggal1", datereq1.ToString("yyyy-MM-dd"));
       MaterialRequestDataSource.SelectParameters.Add("tanggal2", datereq2.ToString("yyyy-MM-dd"));
       MaterialRequestDataSource.SelectParameters.Add("type", "NP");
   ...
   protected void BtnCancelClick(object sender, EventArgs e)
   {
     ...
     foreach (string roles in rolesArray)
     {
       ...
       {
         MaterialRequestDataSource.SelectMethod = "GetDataByUnitManufactureByType";
         MaterialRequestDataSource.SelectParameters.Clear();
         MaterialRequestDataSource.SelectParameters.Add("type", "NP");
   ...
   protected void PnlInputNoteBtnSubmit_Click(object sender, EventArgs e)
   {
     ...
     var mrTableAdapter = new pur_mrTableAdapter();
     var mrdetailTableAdapter = new pur_mrdetailTableAdapter();
     var mrrejectTableAdapter = new pur_rejectTableAdapter();
     ...
     if (mrrejectTableAdapter.Update(purDataSet.pur_reject) > 0)
     {
       CUtils.UpdateLog("pur_reject", idReqNote, getUsername, "Insert MR Reject");
     }
