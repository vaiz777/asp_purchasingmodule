<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="True" CodeBehind="Edit.aspx.cs" Inherits="ManagementSystem.Purchasing.Material_Request.NonProject.Purchase_Order.Edit" Title="Edit PO Non Project" %> 
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
  <title>Purchasing - Edit Purchase Order | PT Tri Ratna Diesel Indonesia</title>
</asp:Content>
...
<div style="padding: 10px">
  <div id="layar" style="border: medium solid #CCCCCC; background-color: White; border-radius: 10px; padding: 15px;" runat="server">
    <div style="font-weight: normal; font-family: 'Trebuchet MS'; font-size: large">
      <img src="../../../../images/icons/icons8-product-documents-48.png" alt="icons8-air-conditioner-48.png" />Edit Purchase Order 
    </div><br />
    <div style="padding-bottom: 15px">
      <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
          <%-- Profil --%>
          <asp:Panel ID="PnlKeteranganRequest" runat="server" GroupingText="Input Purchase Order Item">
              ...
              <table>
                <tr>
                  ...
                  <td class="tableFieldHeader">                  
                    ...
                    <asp:TextBox ID="TxtTanggalPO" runat="server" Width="191px" CssClass="textbox_default" />
                    <act:CalendarExtender ID="TxtTanggalPOCalendar" runat="server" Enabled="True" Format="dd/MM/yyyy" PopupPosition="Right" TargetControlID="TxtTanggalPO" />
                    <asp:RequiredFieldValidator ID="TxtTanggalPOReqValidator" runat="server" ControlToValidate="TxtTanggalPO" Display="None" ErrorMessage="<b>Tgl Purchase Order<b><br/>Wajib diisi." ValidationGroup="PO" />
                    <act:ValidatorCalloutExtender ID="TxtTanggalPOCalloutExtender" runat="server" TargetControlID="TxtTanggalPOReqValidator" />
                  </td>
                  <td>&nbsp;</td>
                  <td class="tableFieldHeader">&nbsp;</td>
                ...
                <tr>
                  ...
                  <td class="tableFieldHeader">:</td>
                  <td class="tableFieldHeader">
                    <asp:TextBox ID="TxtSupplier" runat="server" CssClass="textbox_default" Width="191px"></asp:TextBox>
                  ...
                  <td class="tableFieldHeader">:</td>
                  <td class="tableFieldHeader">
                    <asp:TextBox ID="TxtCurrency" runat="server" CssClass="textbox_default"></asp:TextBox>
                  </td>
                  <td class="tableFieldHeader"></td>
                </tr>
                <tr>
                  ...
                  <td class="tableFieldHeader">:</td>
                  <td class="tableFieldHeader">
                    <asp:TextBox ID="TxtNoMR" runat="server" Width="191px" 
                ...
                <tr>
                  ...
                  <td class="tableFieldHeader">:</td>
                  <td class="tableFieldHeader">
                    <asp:TextBox ID="TxtNamaBarang" runat="server" Width="191px" Enabled="False" 
                      CssClass="textbox_default"></asp:TextBox>
                    <asp:HiddenField ID="HdIdMRDetail" runat="server" />
                  </td>
                  <td>
                    <asp:Button ID="BtnBrowseMRDetail" runat="server" Text="Cari" 
                  ...
                  <td><asp:Button ID="BtnHitung" runat="server" Text="Hitung" 
                      onclick="BtnHitung_Click" /></td>
                </tr>
                <tr>
                  <td class="tableFieldHeader">
                    Jumlah</td>
                  ...
                  <td><asp:Label ID="LblIDR" runat="server" Text="IDR" Visible="False"></asp:Label></td>
                  </asp:Panel>                
                </tr>
                <tr>
                  <td class="tableFieldHeader">
                ...
                <tr>
                  <td colspan="8" class="tableFieldButton">
                    <asp:Button ID="BtnTambah" runat="server" onclick="BtnAdd_Click" 
                      Text="Tambah" />
                  </td>
                </tr>
              </table>
              <br /><br />
              <asp:LinkButton ID="LinkBtnDelete" runat="server" onclick="Delete_Click" >Delete</asp:LinkButton>
              <telerik:RadGrid ID="GridPODetail" runat="server" 
                DataSourceID="PODetailDataSource" GridLines="None" 
                onitemdatabound="GridPODetail_ItemDataBound" AllowPaging="True" 
                AllowSorting="True">
                <MasterTableView AutoGenerateColumns="False" DataKeyNames="id" 
                  DataSourceID="PODetailDataSource" ShowFooter="true">
                  <RowIndicatorColumn>
                  ...
                  <tr>
                    ...
                    <td>
                      <asp:DropDownList ID="PgPODlistPenempatan" runat="server" Width="150px" 
                        AutoPostBack="True" DataSourceID="LokasiGudangDataSource" DataTextField="nama" 
                        DataValueField="id" />
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td class="tableFieldSeparator">:</td>
                    <td>
                      <asp:TextBox ID="PgPOTxtTanggal" runat="server" Width="100px" CssClass="textbox_default" />
                      <act:CalendarExtender ID="PgPOTxtTanggalCalendar" runat="server" Enabled="True" Format="dd/MM/yyyy" PopupPosition="Right" TargetControlID="PgPOTxtTanggal" />
                      <asp:RequiredFieldValidator ID="PgPOTxtTanggalReqValidator" runat="server" ControlToValidate="PgPOTxtTanggal" Display="None" ErrorMessage="<b>Tgl Penyerahan<b><br/>Wajib diisi." ValidationGroup="PO" />
                      <act:ValidatorCalloutExtender ID="PgPOTxtTanggalCalloutExtender" runat="server" TargetControlID="PgPOTxtTanggalReqValidator" />
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td class="tableFieldSeparator">:</td>
                    <td>
                      <asp:TextBox ID="PgPOTxtCatatan" runat="server" CssClass="textbox_default"  
            ...
            <telerik:RadPageView ID="PgPONotes" runat="server">
              <div style="padding:15px">
                <table>
                  ...
                  <tr>
                    <td colspan="2">
                      <asp:TextBox ID="PgPOTxtKeterangan" runat="server" CssClass="textbox_default" 
                        Height="85px" Width="380px" TextMode="MultiLine"></asp:TextBox>
                    </td>
                  </tr>
                </table>
              </div>              
          ...
          <div style="padding-top:10px">
            <asp:Button ID="BtnSaveAll" runat="server" onclick="BtnSaveAll_Click" Text="Simpan" />               
            <asp:Button ID="BtnBack" runat="server" onclick="BtnBack_Click" Text="Kembali" /><br />
          </div>          
        </ContentTemplate>
      </asp:UpdatePanel>
    </div>
...
<asp:ObjectDataSource ID="MRDetailDataSource" runat="server" 
  ...
  <SelectParameters>
    ...
    <asp:ControlParameter ControlID="TxtNoMR" Name="mrId" PropertyName="Text" 
...
<asp:ObjectDataSource ID="LokasiGudangDataSource" runat="server" 
...
<asp:ObjectDataSource ID="PODetailDataSource" runat="server" 
  ...
  <SelectParameters>
    <asp:ControlParameter ControlID="HdIdPO" Name="poid" PropertyName="Value" 
      Type="String" DefaultValue="0" />
  </SelectParameters>
</asp:ObjectDataSource>
...
<asp:UpdatePanel ID="UpdatePanel5" runat="server">
  <ContentTemplate>
    <act:ModalPopupExtender ID="PnlViewSupplierModalPopupExtender" runat="server" Enabled="True" TargetControlID="PnlViewSupplierLinkButton" CancelControlID="PnlViewSupplierBtnClose" DropShadow="false" PopupControlID="PnlViewSupplier" PopupDragHandleControlID="PnlViewSupplierTitlebar" BackgroundCssClass="modalBackground" />
      <asp:Panel ID="PnlViewSupplier" runat="server" Width="70%" CssClass="modalPopup">
    ...
    <act:ModalPopupExtender ID="PnlRequestNoteModalPopupExtender" runat="server" Enabled="True" TargetControlID="PnlRequestNoteLinkButton" CancelControlID="PnlRequestNoteBtnClose" DropShadow="false" PopupControlID="PnlRequestNote" PopupDragHandleControlID="PnlRequestNoteTitlebar" BackgroundCssClass="modalBackground" />
      <asp:Panel ID="PnlRequestNote" runat="server" Width="70%" CssClass="modalPopup">
          ...
          <div style="padding:5px; text-align:left">
            <table>
              <tr>
                ...
                <td>
                  <asp:Label ID="Label6" runat="server" Text="Daftar Nomor Request" />
                </td>
              </tr>
            </table>
          </div>
        ...
        <telerik:RadGrid ID="GridMR" runat="server" GridLines="None" 
            ...
            style="font-style: italic" onitemdatabound="GridMR_ItemDataBound" 
...
<asp:UpdatePanel ID="UpdatePanel10" runat="server">
  <ContentTemplate>
    <act:ModalPopupExtender ID="PnlViewRequestNoteModalPopupExtender2" runat="server" Enabled="True" TargetControlID="PnlViewRequestNoteLinkButton2" CancelControlID="PnlViewRequestNoteBtnClose2" DropShadow="false" PopupControlID="PnlViewRequestNote2" PopupDragHandleControlID="PnlViewRequestNoteTitlebar2" BackgroundCssClass="modalBackground" />
      <asp:Panel ID="PnlViewRequestNote2" runat="server" Width="770px" CssClass="modalPopup" >
        <asp:Panel ID="PnlViewRequestNoteTitlebar2" runat="server" CssClass="modalPopupTitle">
          <div style="padding:5px; text-align:left">
            <table>
              <tr>
                <td>
                ...
                <td>
                  <asp:Label ID="Label15" runat="server" Text="Daftar Barang Per MR" />
                </td>
              </tr>
            </table>
          </div>
        ...
        <div style="padding:5px">
          <telerik:RadGrid ID="GridMRDetail" runat="server" GridLines="None" 
            AllowPaging="True" AllowSorting="True" 
            onitemcommand="GridMRDetail_ItemCommand" 
        ...
        <div style="text-align: center; padding-top: 10px">
          <asp:LinkButton ID="PnlViewRequestNoteLinkButton2" runat="server" Style="display: none">LinkButton</asp:LinkButton>&nbsp;
          <asp:Button ID="PnlViewRequestNoteBtnClose2" runat="server" Text="Close" /><br />
        </div>
      </asp:Panel>
  </ContentTemplate>
</asp:UpdatePanel>
