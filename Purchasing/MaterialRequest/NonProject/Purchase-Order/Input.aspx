<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="True" CodeBehind="Input.aspx.cs" Inherits="ManagementSystem.Purchasing.Material_Request.NonProject.Purchase_Order.Input" Title="Input PO Non Project" %>
        ...
        <asp:Panel ID="PnlViewSupplier" runat="server" Width="80%" CssClass="modalPopup">
          ...
          <div style="padding:5px;">
            ...
            <telerik:RadGrid ID="GridSupplier" runat="server" AllowPaging="True" 
              AllowSorting="True" GridLines="None" onitemcommand="GridSupplier_ItemCommand" 
