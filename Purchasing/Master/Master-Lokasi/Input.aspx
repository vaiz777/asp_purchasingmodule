<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Input.aspx.cs" Inherits="ManagementSystem.Purchasing.Master.Master_Lokasi.Input" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
  <title>Purchasing - Input Lokasi | PT Tri Ratna Diesel Indonesia</title>
</asp:Content>
...
<div style="padding: 10px">
  <div style="border: medium solid #CCCCCC; background-color: White; border-radius: 10px; padding: 15px; width: 80%">
    <div style="font-weight: normal; font-family: 'Trebuchet MS'; font-size: large">
      <img src="../../../images/icons/icons8-product-documents-48.png" alt="icons8-air-conditioner-48.png" />&nbsp;Input Lokasi
    </div><br />
    <div style="padding-bottom: 15px">
      <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
          <table>
            <tr>
              <td class="tableFieldHeader">Kode Lokasi</td>
              <td class="tableFieldHeader">:</td>
              <td>
                <asp:TextBox ID="TxtKodeLokasi" runat="server" CssClass="textbox_default" />
              </td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              ...
              <td class="tableFieldHeader">
                <asp:TextBox ID="TxtNamaLokasi" runat="server" CssClass="textbox_default"  />
              </td>
              <td>&nbsp;</td>
            </tr>
          </table>
