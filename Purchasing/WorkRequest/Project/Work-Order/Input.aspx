<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Input.aspx.cs" Inherits="ManagementSystem.Purchasing.WorkRequest.Project.Work_Order.Input" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
  <title>Input Work Order (Project) - Purchasing | PT Tri Ratna Diesel Indonesia</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <div style="padding:10px;">
    <div style="border: medium solid #CCCCCC; background-color: White; border-radius: 10px; padding: 15px">
      <div style="font-weight: normal; font-family: 'Trebuchet MS'; font-size: large">
          <img src="/images/icons/icons8-compose-48.png" alt="icons8-compose-48.png"  />&ensp;Input Work Order (Project)
      </div><br />
      <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
          <asp:Panel ID="PnlInputPO1" runat="server" GroupingText="Input Item WO">
            <table>
              <tr>
                ...
                <td>
                  ...
                  <table>
                    <tr>
                      ...
                      <td><asp:Button ID="Pnl1BtnBrowseMasterProject" runat="server" Text="..." onclick="Pnl1BtnBrowseMasterProject_Click" /></td>
                    </tr>
                  </table>
                </td>
              ...
              <tr>
                ...
                <td style="width:20px">&nbsp;</td>
                <td rowspan="2" class="tableFieldHeader" valign="middle">Total</td>
                <td class="tableFieldHeader">:</td>
                <td>
                  <asp:RadioButton ID="Pnl1RbPerItemJasa" runat="server" Text="Per Jasa" GroupName="rb" AutoPostBack="True" oncheckedchanged="Pnl1RbPerItemJasa_CheckedChanged" />&ensp;
                  <asp:RadioButton ID="Pnl1RbSatuan" runat="server" Text="Satuan" GroupName="rb" oncheckedchanged="Pnl1RbSatuan_CheckedChanged" AutoPostBack="true" />
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <asp:Panel ID="PnlKurs" runat="server" Visible="false">
                  ...
                  <td class="tableFieldHeader">:</td>
                  <td>
                    <telerik:RadNumericTextBox ID="Pnl1RadNmrcTxtKurs" Runat="server" NumberFormat-DecimalDigits="2"></telerik:RadNumericTextBox>
                  </td>
                </asp:Panel>
                <td style="width:20px"></td>
                <td></td>
      ...
      <asp:UpdatePanel ID="UpdatePanel7" runat="server">
        <ContentTemplate>
              ...
              <div style="padding: 10px">
                <table>
                  ...
                  <tr>
                    ...
                    <td class="tableFieldHeader">:</td>
                    <td>
                      <asp:DropDownList ID="PgBiayaDListPPN" runat="server" onselectedindexchanged="PgBiayaDListPPN_SelectedIndexChanged" AutoPostBack="true">
              ...
              <div style="padding: 10px">
                <table>
                  ...
                  <tr>
                    ...
                    <td class="tableFieldHeader">:</td>
                    <td>
                      <telerik:RadDatePicker ID="PgLainRadTxtTglPenyelesaian" runat="server" 
                        MinDate="1980-01-02" >
          ...
          <div>
            <asp:Button ID="BtnSave" runat="server" Text="Simpan WO" onclick="BtnSave_Click" />&ensp;
  ...
  <asp:ObjectDataSource ID="WODetailDataSource" runat="server" 
    ...
    <SelectParameters>
      <asp:ControlParameter ControlID="HdIdWO" DefaultValue="0" Name="woId" 
    ...
    <ContentTemplate>
      ...
      <div style="padding: 5px">
        ...
        <div style="padding:10px; text-align:left">
          ...
          <telerik:RadGrid ID="GridMasterProject" runat="server" AllowPaging="True" DataSourceID="MasterProjectDataSource" GridLines="None" onitemcommand="GridMasterProject_ItemCommand">
          <MasterTableView AutoGenerateColumns="False" DataKeyNames="id,salescustomer_id" DataSourceID="MasterProjectDataSource">
            ...
            <Columns>
              ...
              <telerik:GridBoundColumn DataField="projectstart" DataType="System.DateTime" HeaderText="Project Start" SortExpression="projectstart" UniqueName="projectstart" DataFormatString="{0:d}" ItemStyle-HorizontalAlign="Center" />
              <telerik:GridBoundColumn DataField="projectend" DataType="System.DateTime" HeaderText="Project End" SortExpression="projectend" UniqueName="projectend" DataFormatString="{0:d}" ItemStyle-HorizontalAlign="Center" />
              <telerik:GridBoundColumn DataField="warrantystart" DataType="System.DateTime" HeaderText="Warranty Start" SortExpression="warrantystart" UniqueName="warrantystart" DataFormatString="{0:d}" ItemStyle-HorizontalAlign="Center" />
              <telerik:GridBoundColumn DataField="warrantyend" DataType="System.DateTime" HeaderText="Warranty End" SortExpression="warrantyend" UniqueName="warrantyend" DataFormatString="{0:d}" ItemStyle-HorizontalAlign="Center" />
            </Columns>
            <HeaderStyle HorizontalAlign="Center" />
          </MasterTableView>            
  ...
  <asp:UpdatePanel ID="UpdatePanel6" runat="server">
    <ContentTemplate>
      ...
      <asp:Panel ID="PnlBrowseSupplier" runat="server" Width="85%" CssClass="modalPopup" >
      <div style="padding: 5px">
          ...
          <div style="padding:5px; text-align:left">
            <table>
                <tr>
                  ...
                  <td class="">
                    <asp:Label ID="Label1" runat="server" Text="List Supplier" />
                  </td>
                </tr>
              </table>            
          </div>
  ...
  <asp:UpdatePanel ID="UpdatePanel4" runat="server">
    <ContentTemplate>
      ...
      <asp:Panel ID="PnlBrowseWorkRequest" runat="server" Width="70%" CssClass="modalPopup" >
      <div style="padding: 5px">
        ...
        <div style="padding:10px;">
          ...
          <telerik:RadGrid ID="GridWorkRequest" runat="server" AllowPaging="True" 
            ...
            onitemdatabound="GridWorkRequest_ItemDataBound">
  ...
  <asp:UpdatePanel ID="UpdatePanel5" runat="server">
    <ContentTemplate>
      ...
      <div style="padding: 5px">
          ...
          <div style="padding:5px; text-align:left">
            <table>
                <tr>
                  ...
                  <td class="">
                    <asp:Label ID="Label3" runat="server" Text="Data WR Detail" />
                  </td>
                </tr>
              </table>            
          </div>
        ...
        <div style="padding:10px;">
          <telerik:RadGrid ID="GridJasa" runat="server" AllowPaging="True" 
            AllowSorting="True" DataSourceID="WRDetailDataSource" GridLines="None" 
            onitemcommand="GridJasa_ItemCommand" 
            onpageindexchanged="GridJasa_PageIndexChanged" 
            onpagesizechanged="GridJasa_PageSizeChanged">
