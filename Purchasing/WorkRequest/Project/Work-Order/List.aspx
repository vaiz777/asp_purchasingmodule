<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="ManagementSystem.Purchasing.WorkRequest.Project.Work_Order.List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
  <title>List Work Order (Project) - Purchasing | PT Tri Ratna Diesel Indonesia</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <div style="padding:10px;">
    <div style="border: medium solid #CCCCCC; background-color: White; border-radius: 10px; padding: 15px">
      <div style="font-weight: normal; font-family: 'Trebuchet MS'; font-size: large">
          <img src="/images/icons/icons8-bill-48.png" alt="icons8-bill-48.png"  />&ensp;Daftar Work Order (Project)
      </div><br />
      ...
      <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
              ...
              <tr>
                ...
                <td>
                  <asp:DropDownList ID="DlistBerdasarkan" runat="server" AutoPostBack="True" onselectedindexchanged="DlistBerdasarkan_SelectedIndexChanged">
                    ...
                    <asp:ListItem Value="5">Tanggal</asp:ListItem>
                  </asp:DropDownList>
                </td>
              </tr>
              <tr>
          ...
          <telerik:RadGrid ID="GridWO" runat="server" AllowPaging="True" 
            ...
            onitemdatabound="GridWO_ItemDataBound" 
            onitemcommand="GridWO_ItemCommand">
            <MasterTableView AutoGenerateColumns="False" DataSourceID="WODataSource">
              <Columns>
                <telerik:GridBoundColumn DataField="id" HeaderText="id" SortExpression="id" UniqueName="id" ItemStyle-HorizontalAlign="Center" Visible="false" />
                <telerik:GridBoundColumn DataField="nomerwo" HeaderText="No." SortExpression="nomerwo" UniqueName="nomerwo" ItemStyle-HorizontalAlign="Center" ItemStyle-Font-Bold="true" />
                <telerik:GridBoundColumn DataField="tglwo" HeaderText="Tanggal" SortExpression="tglwo" UniqueName="tglwo" DataType="System.DateTime" DataFormatString="{0:d}" ItemStyle-HorizontalAlign="Center" />
                ...
                <telerik:GridBoundColumn DataField="unitkerja" HeaderText="Unitkerja" SortExpression="unitkerja" UniqueName="unitkerja" ItemStyle-HorizontalAlign="Center" />
  ...
  <asp:ObjectDataSource ID="WODataSource" runat="server" 
    ...
    onselecting="PurchaseOrderDataSource_Selecting" 
    ...
    <div>
      ...
      <div style="padding:5px; text-align:left">
          ...
          <ContentTemplate>
            <table>
              <tr>
                ...
                <td style="padding: 5px">
                  <asp:Label ID="Label1" runat="server" Text="Cetak Work Order dengan nomor "  />
                  <asp:HiddenField ID="PnlPrintHdIdWO" runat="server" />
                  <asp:Label ID="PnlPrintLblNoWO" runat="server" />
                </td>
              </tr>
            </table>
          </ContentTemplate>
        ...
        <div style="text-align: center; padding-top: 10px">
          ...
          <asp:Button ID="PnlPrintBtnOk" runat="server" Text="Batal"  />
            ...
            <table>
              <tr>
                ...
                <td style="padding: 5px; font-size:15px" valign="middle">
                  <asp:Label ID="Label3" runat="server" Text="Apakah nomer WO " />
                  <asp:HiddenField ID="PnlCLoseHdIdWO" runat="server" />
                  <asp:Label ID="PnlCloseLblNoWO" runat="server" />
                  <asp:Label ID="Label4" runat="server" Text=" telah selesai ?" />
                </td>
              </tr>
            </table>
            <div style="text-align: center; padding-top: 10px">
              <asp:Button ID="PnlCloseBtnOk" runat="server" Text="Ya" onclick="PnlCloseBtnOk_Click" />&ensp;&ensp;
              <asp:Button ID="PnlCloseBtnClose" runat="server" Text="Batal"  />
