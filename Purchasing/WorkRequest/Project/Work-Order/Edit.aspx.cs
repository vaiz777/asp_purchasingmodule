  ...
  public partial class Edit : System.Web.UI.Page
  {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      if (!IsPostBack) {
        ...
        if (woTableAdapter.FillById(purDataSet.pur_wo, id) > 0)
        {
          ...
          RDateTanggalWO.SelectedDate = purDataSet.pur_wo[0].tglwo;
          ...
          PgBiayaHdDiskonVal.Value = Convert.ToDouble(purDataSet.pur_wo[0].diskonval).ToString();
          PgBiayaDListPPN.SelectedValue = purDataSet.pur_wo[0].ppn.ToString();
          PgBiayaHdPPNVal.Value = Convert.ToDouble(purDataSet.pur_wo[0].ppnval).ToString();
          PgBiayaRadTxtPPh.Value = purDataSet.pur_wo[0].pph;
          PgBiayaHdPPhVal.Value = Convert.ToDouble(purDataSet.pur_wo[0].ppnval).ToString();
    ...
    protected void Pnl1BtnAdd_Click(object sender, EventArgs e)
    {
      ...
      try
      {
        ...
        wodetailRow.kurs = Pnl1RadNmbrcTxtKurs.Value == null ? 0 : Convert.ToDouble(Pnl1RadNmbrcTxtKurs.Value);
        ...
        {
          CUtils.UpdateLog("pur_wrdetail", HdIdWRDetail.Value, Session["Username"].ToString(), "Update WR Detail Status 'Add to WO'");
        }
        ...
        UpdateStatusOrdernoteWr(HdIdWO.Value);
    ...
    {
      //Pnl1LblIdProject.Text = string.Empty;
      Pnl1TxtNoProject.Enabled = false;
      Pnl1BtnBrowseMasterProject.Visible = false;
      Pnl1TxtSupplier.Enabled = false;
      Pnl1BtnBrowseSupplier.Visible = false;
      Pnl1TxtNoWR.Text = string.Empty;
      HdIdWRDetail.Value = null;
      ...
      PnlKurs.Visible = false;
      Pnl1RadNmbrcTxtKurs.Text = string.Empty;
    ...
    protected void BtnSave_Click(object sender, EventArgs e)
    {
      ...
      try
      {
        purDataSet.pur_wo[0].tglwo = RDateTanggalWO.SelectedDate.Value == null ? RDateTanggalWO.MinDate : RDateTanggalWO.SelectedDate.Value;
        purDataSet.pur_wo[0].ppn = Convert.ToSingle(PgBiayaDListPPN.SelectedValue);
        purDataSet.pur_wo[0].ppnval = Convert.ToDecimal(PgBiayaHdPPNVal.Value);
        purDataSet.pur_wo[0].pph = PgBiayaRadTxtPPh.Value == null ? 0 : Convert.ToSingle(PgBiayaRadTxtPPh.Value);
        purDataSet.pur_wo[0].pphval = Convert.ToDecimal(PgBiayaHdPPhVal.Value);
        ...
        purDataSet.pur_wo[0].diskonval = Convert.ToDecimal(PgBiayaHdDiskonVal.Value);
    ...
    protected void PnlMasterProjectBtnSearch_Click(object sender, EventArgs e)
    {
      ...
      if (PnlMasterProjectDlistSearchBy.SelectedValue == "0")
      {
    ...
    protected void PgBiayaTxtBiayaLain_TextChanged(object sender, EventArgs e)
    {
    }
    ...
    protected void Pnl1RbItemJasa_CheckedChanged(object sender, EventArgs e)
    {
      ...
      Pnl1RadNmrcTxtTotal.Text = Convert.ToString(total);
    }
