<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Detail.aspx.cs" Inherits="ManagementSystem.Purchasing.WorkRequest.Project.Work_Order.Detail" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
  <title>Detail Work Order (Project) - Purchasing | PT Tri Ratna Diesel Indonesia</title>
</asp:Content>
...
<div style="padding: 10px">
    <div style="border: medium solid #CCCCCC; background-color: White; border-radius: 10px; padding: 15px;">
      <div style="font-weight: normal; font-family: 'Trebuchet MS'; font-size: large;">
        <img src="/images/icons/icons8-view-48.png" alt="icons8-view-48.png" />&nbsp;Detail Work Order (Project)<br />
      </div><br />
      ...
      <table style=" font-size: ">
        ...
        <tr>
          ...
          <td class="tableFieldHeader">:</td>
          <td>
            <asp:Label ID="LblTglPenyelesaian" runat="server"></asp:Label>
          </td>
        </tr>
        <tr>
      ...
      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        CellPadding="4" DataKeyNames="id" DataSourceID="WODetailDataSource" 
