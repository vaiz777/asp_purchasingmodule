...
namespace ManagementSystem.Purchasing.WorkRequest.Project.Price_Request
{
  public partial class Kelola : System.Web.UI.Page
  {
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      LblNoProject.Text = purDataSet.vpur_wr01[0].project_nomor;
      LblKategori.Text = purDataSet.vpur_wr01[0].kategori_nama;
      ...
      LblUsable.Text = purDataSet.vpur_wr01[0].usable_nama;
