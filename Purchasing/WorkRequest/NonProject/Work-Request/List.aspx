<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="ManagementSystem.Purchasing.WorkRequest.NonProject.Work_Request.List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
  <title>Daftar Work Request - Purchasing | PT Tri Ratna Diesel Indonesia</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <div style="padding:10px;">
    <div style="border: medium solid #CCCCCC; background-color: White; border-radius: 10px; padding: 15px">
      ...
      <asp:UpdatePanel ID="UpdatePanel3" runat="server">
        <ContentTemplate>
          <table>
            ...
            <asp:Panel ID="PnlRangeTgl" runat="server" Visible="false">
            <tr>
            ...
            <tr>
              ...
              <td> 
                <asp:DropDownList ID="DlistBerdasarkan" runat="server" AutoPostBack="true" onselectedindexchanged="DlistBerdasarkan_SelectedIndexChanged">
                  ...
                  <asp:ListItem Value="3">Kode Reference</asp:ListItem>
                </asp:DropDownList>
              </td>
            </tr>
            <tr>
              <td colspan="3" style="padding-top: 10px">                
                <%--<div style="display: none"><asp:Button ID="BtnSearchDrktr" runat="server" Text="Cari1" OnClick="BtnSearchDrktr_Click" Visible="false" /></div>
                <div style="display:none"><asp:Button ID="BtnSearchMnfc" runat="server" Text="Cari2" OnClick="BtnSearchMnfctr_Click" Visible="false" /></div>--%>                
                <%--<asp:Button ID="BtnSearchDrktr" runat="server" Text="Cari1" OnClick="BtnSearchDrktr_Click" Visible="false" />
                <asp:Button ID="BtnSearchMnfc" runat="server" Text="Cari2" OnClick="BtnSearchMnfctr_Click" Visible="false" />--%>
      ...
      <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
          <telerik:RadGrid ID="GridRequestNote" runat="server" AllowPaging="True" DataSourceID="WRDataSource" GridLines="None" onitemcommand="GridRequestNote_ItemCommand" onitemdatabound="GridRequestNote_ItemDataBound" AllowSorting="True">
            <MasterTableView AutoGenerateColumns="False" DataSourceID="WRDataSource" DataKeyNames="id">
              <Columns>
  ...
  <asp:ObjectDataSource ID="WRDataSource" runat="server" 
    ...
    oninit="RequestNoteDataSource_Init">
    <SelectParameters>
  ...
  <asp:UpdatePanel ID="UpdatePanel2" runat="server">
    <ContentTemplate>
      ...
      <asp:Panel ID="PnlDetail" runat="server" Width="75%" CssClass="modalPopup" >
      <div style="padding: 5px">
          ...
          <div style="padding:5px; text-align:left">
            <table>
                <tr>
                  ...
                  <td class="">
                    <asp:Label ID="PnlDetailLblTitlebar" runat="server" Text="Detail Work Request" />
                  </td>
                </tr>
              </table>            
          </div>
        ...
        <div style="padding:10px; text-align:left">
          <telerik:RadTabStrip ID="RadTabStrip1" runat="server" SelectedIndex="0" MultiPageID="RadMultiPage1">
            <Tabs>
              <telerik:RadTab runat="server" Selected="True" Text="Work Request" />
          ...
          <telerik:RadMultiPage ID="RadMultiPage1" runat="server"  Width="100%"  SelectedIndex="0" BorderStyle="Solid" BorderColor="#999999" BorderWidth="1px" BackColor="White">
            ...
            <telerik:RadPageView ID="RadPageView2" runat="server">
              <div style="padding:15px">
                <telerik:RadGrid ID="GridRequestJasa" runat="server" AllowPaging="True" 
                  DataSourceID="WRDetailDataSource" GridLines="None"  
                  onitemcreated="GridRequestJasa_ItemCreated" 
                  onitemdatabound="GridRequestJasa_ItemDataBound" 
                  onpageindexchanged="GridRequestJasa_PageIndexChanged" 
                  onpagesizechanged="GridRequestJasa_PageSizeChanged">
