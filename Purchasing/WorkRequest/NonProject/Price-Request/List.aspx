<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="ManagementSystem.Purchasing.WorkRequest.NonProject.Price_Request.List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
  <title>Permintaan Harga - Purchasing | PT Tri Ratna Diesel Indonesia</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <div style="padding:10px;">
    <div style="border: medium solid #CCCCCC; background-color: White; border-radius: 10px; padding: 15px">
      <div style="font-weight: normal; font-family: 'Trebuchet MS'; font-size: large">
        <img src="/images/icons/icons8-list-48.png" alt="icons8-list-48.png"  />&ensp;<asp:Label ID="LblTitle" runat="server" Text=""></asp:Label>
      </div><br />
      ...
      <asp:Panel ID="PnlContent2" runat="server" Visible="false">
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
          <ContentTemplate>
                ...
                <tr>
                  ...
                  <td>
                    <asp:DropDownList ID="DlistBerdasarkan" runat="server" AutoPostBack="true" onselectedindexchanged="DlistBerdasarkan_SelectedIndexChanged">
                      ...
                      <asp:ListItem Value="2">Tanggal WR</asp:ListItem>
                    </asp:DropDownList>
                  </td>
                </tr>
                <tr>
            ...
            <telerik:RadGrid ID="GridReqNote" runat="server" AllowPaging="True" AllowSorting="True" DataSourceID="WRDataSource" GridLines="None" onitemcommand="GridReqNote_ItemCommand" onitemdatabound="GridReqNote_ItemDataBound">
              <MasterTableView AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="WRDataSource">
                <Columns>
                  <telerik:GridBoundColumn DataField="id" HeaderText="No WR" ReadOnly="True" SortExpression="id" UniqueName="id" ItemStyle-HorizontalAlign="Center" ItemStyle-Font-Bold="true" />
                  <telerik:GridBoundColumn DataField="tglwr" HeaderText="Tgl" SortExpression="tglwr" UniqueName="tglwr" DataType="System.DateTime" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:d}" />
                  ...
                  <telerik:GridBoundColumn DataField="status" HeaderText="Status" ItemStyle-HorizontalAlign="Center" SortExpression="status" UniqueName="status" />
  ...
  <asp:ObjectDataSource ID="WRDataSource" runat="server" 
    ...
    onselecting="ReqNoteDataSource_Selecting" oninit="ReqNoteDataSource_Init">
    <SelectParameters>
        ...
        <div style="padding: 5px">
          ...
          <div style="padding:10px; text-align:left">
            <telerik:RadTabStrip ID="RadTabStrip1" runat="server" SelectedIndex="0" MultiPageID="RadMultiPage1">
              <Tabs>
                <telerik:RadTab runat="server" Selected="True" Text="Work Request"></telerik:RadTab>
                <telerik:RadTab runat="server" Text="Item Jasa"></telerik:RadTab>
              </Tabs>
            </telerik:RadTabStrip>
            <telerik:RadMultiPage ID="RadMultiPage1" runat="server" SelectedIndex="0" BorderStyle="Solid" BorderColor="#999999" BorderWidth="1px" BackColor="White">
                ...
                <div style="padding:10px">
                  <table>
                    <tr>
                      ...
                      <td class="tableFieldHeader">:</td>
                      <td><asp:Label ID="LblDetailNoWR" runat="server"></asp:Label></td>
                    </tr>
                    <tr>
                      <td class="tableFieldHeader">Tgl WR</td>
                      <td class="tableFieldHeader">:</td>
                      <td><asp:Label ID="LblDetailTglWR" runat="server"></asp:Label></td>
                    </tr>
                    <tr>
                      <td class="tableFieldHeader">Lokasi</td>
                      <td class="tableFieldHeader">:</td>
                      <td><asp:Label ID="LblDetailLokasi" runat="server"></asp:Label></td>
                    </tr>
                    <asp:Panel ID="PnlUsable" runat="server">
                      <tr>
                        <td class="tableFieldHeader">Usable / Jenis Kategori</td>
                        <td class="tableFieldHeader">:</td>
                        <td><asp:Label ID="LblDetailKategori" runat="server"></asp:Label></td>
                      </tr>
                    </asp:Panel>
                    <tr>
                      <td class="tableFieldHeader">Departement</td>
                      <td class="tableFieldHeader">:</td>
                      <td><asp:Label ID="LblDetailDepartment" runat="server"></asp:Label></td>
                    </tr>
                    <asp:Panel ID="PnlScope" runat="server">
                      <tr>
                        <td class="tableFieldHeader">Scope</td>
                        <td class="tableFieldHeader">:</td>
                        <td><asp:Label ID="LblDetailScope" runat="server"></asp:Label></td>
                      </tr>
                    </asp:Panel>
                    <tr>
                      <td class="tableFieldHeader">Kode Referensi</td>
                      <td class="tableFieldHeader">:</td>
                      <td><asp:Label ID="LblDetailNoReferensi" runat="server"></asp:Label></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td class="tableFieldHeader">:</td>
                      <td><asp:Label ID="LblDetailDibuatOleh" runat="server"></asp:Label></td>
                    </tr>
                    <tr>
                      <td class="tableFieldHeader">Unit Kerja</td>
                      <td class="tableFieldHeader">:</td>
                      <td><asp:Label ID="LblDetailUnitKerja" runat="server"></asp:Label></td>
                    </tr>
                  </table><br />
                </div>
              </telerik:RadPageView>
              <telerik:RadPageView ID="RadPageView2" runat="server" Width="100%">
                <div style="padding:10px">
                  <telerik:RadGrid ID="GridRequestJasa" runat="server" AllowPaging="True" DataSourceID="WRDetailDataSource" GridLines="None" onitemdatabound="GridRequestJasa_ItemDataBound" onpageindexchanged="GridRequestJasa_PageIndexChanged" onpagesizechanged="GridRequestJasa_PageSizeChanged">
          ...
          <div style="padding-top:10px; text-align:center">
            ...
            <asp:Button ID="PnlDetailBtnClose" runat="server" Text="Tutup" onclick="PnlDetailBtnClose_Click" /><br />
          </div>
        </div>
      </asp:Panel>
    </ContentTemplate>
    ...
    <ContentTemplate>
      ...
      <div style="padding: 5px">
          ...
          <div style="padding:5px; text-align:left">
            <table>
                <tr>
                  ...
                  <td class="">
                    <asp:Label ID="PnlCheckLblTitlebar" runat="server" Text="Approve Request Jasa" />
                  </td>
                </tr>
              </table>            
          </div>
          ...
          <table>
            <tr>
              ...
              <td class="tableFieldValue">
                <asp:TextBox ID="PnlCheckTxtNoWR" runat="server" CssClass="textbox_default" 
                  Enabled="false"></asp:TextBox>
              </td>
            </tr>
          </table><br />
          <telerik:RadGrid ID="GridApproveReqJasa" runat="server" AllowPaging="True" 
            DataSourceID="CheckWRDetailDataSource" GridLines="None" 
            onitemcreated="GridApproveReqJasa_ItemCreated" 
            onitemdatabound="GridApproveReqJasa_ItemDataBound" 
            ondatabound="GridApproveReqJasa_DataBound" 
            onpageindexchanged="GridApproveReqJasa_PageIndexChanged" 
            onpagesizechanged="GridApproveReqJasa_PageSizeChanged">
            <MasterTableView AutoGenerateColumns="False" DataKeyNames="id" 
              DataSourceID="CheckWRDetailDataSource">
              <Columns>
        ...
        <div style="padding-top:10px; text-align:center">
          ...
          <asp:Button ID="PnlCheckBtnClose" runat="server" Text="Tutup" onclick="PnlCheckBtnClose_Click" /><br />
            ...
            <table>
              <tr>                
                <td class="tableFieldHeader" style="padding: 5px">
                  ...
                  <asp:TextBox ID="PnlInputNoteTxtKeterangan" runat="server" TextMode="MultiLine" Width="350px" CssClass="tableFieldHeader" placeholder="Input kerangan disini.." ></asp:TextBox>
                </td>
