<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Kelola.aspx.cs" Inherits="ManagementSystem.Purchasing.WorkRequest.NonProject.Price_Request.Kelola" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
  <title>Kelola Work Request - Purchasing | PT Tri Ratna Diesel Indonesia</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="border: medium solid #CCCCCC; background-color: White; border-radius: 10px; padding: 15px">
      ...
      <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div style="padding: 10px">
              <table>
                <tr>
                  ...
                  <td class="tableFieldHeader" style="width: 10px">:</td>
                  <td>
                    <asp:Label ID="LblNoWR" runat="server" />
                  </td>
                </tr>
                <tr>
                  <td class="tableFieldHeader" style="width: 150px">Tgl WR</td>
                  <td class="tableFieldHeader" style="width: 10px">:</td>
                  <td>
                    <asp:Label ID="LblTglWR" runat="server" />
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <asp:Label ID="LblLokasi" runat="server" />
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td class="tableFieldHeader">:</td>
                  <td>
                    <asp:Label ID="LblJenisKategori" runat="server" />
                  </td>
                </tr>
                </asp:Panel>
                <tr>
                ...
                <tr>
                  ...
                  <td class="tableFieldHeader">:</td>
                  <td>
                    <asp:Label ID="LblScope" runat="server" />
                  </td>
                </tr>
                </asp:Panel>
                <tr>
                ...
                <tr>
                  ...
                  <td class="tableFieldHeader">:</td>
                  <td>
                    <asp:Label ID="LblDibuatOleh" runat="server" />
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="tableFieldHeader">:</td>
                  <td>
                    <asp:Label ID="LblUnitKerja" runat="server" />
                  </td>
                </tr>
              </table>
            </div>
          ...
          <%--<asp:Panel ID="Panel2" runat="server" GroupingText="Item Jasa">--%>
            <div style="padding: 10px;">
              ...
              <telerik:RadGrid ID="GridItemJasa" runat="server" AllowPaging="True" 
                ...
                ondatabound="GridItemJasa_DataBound">
          ...
          <asp:Button ID="BtnKembali" runat="server" Text="Kembali" OnClick="BtnBack_Click" />
        </ContentTemplate>
      </asp:UpdatePanel>
    </div>
  </div>
 ...
 <asp:UpdatePanel ID="UpdatePanel3" runat="server">
    <ContentTemplate>
      <act:ModalPopupExtender ID="PnlViewModalPopupExtender" runat="server" Enabled="True" TargetControlID="PnlViewLinkButton" DropShadow="false" PopupControlID="PanelView" PopupDragHandleControlID="PnlView" BackgroundCssClass="modalBackground" CancelControlID="PnlViewBtnClose" />
        <asp:Panel ID="PanelView" runat="server" Width="60%" CssClass="modalPopup" >
          ...
          <asp:Panel ID="PnlView" runat="server" CssClass="modalPopupTitle">
            <div style="padding:5px; text-align:left">
              <table>
                <tr>
                  <td class="">
                    <img src="/images/icons/icons8-brief-48.png" alt="icons8-brief-48.png" />
                  </td>
                  <td class="">
          ...
          <div style="padding:10px">
            <table>
              ...
              <tr>
                ...
                <td class="tableFieldHeader">:</td>
                <td>
                  <asp:Label ID="LblJmlJasa" runat="server"></asp:Label><asp:Label ID="LblSatuan" runat="server"></asp:Label>
                </td>
                <td style="width: 30px"></td>
              ...
              <asp:Panel ID="PnlKelola" runat="server">
              <tr>
