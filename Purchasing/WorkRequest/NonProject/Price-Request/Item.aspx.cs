...
namespace ManagementSystem.Purchasing.WorkRequest.NonProject.Price_Request
{
  public partial class Item : System.Web.UI.Page
  {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      if (unitkerja == "S.M") { LblTitle.Text = "Item Jasa (Non Project)"; PnlSM.Visible = true; }
      else { LblTitle.Text = "Item Jasa"; PnlSM.Visible = false; }
      ...
      if (!IsPostBack)
      {
        ...
        else
        {
          ...
          HdKdJasa.Value = purDataSet.vpur_wrdetail01[0].jasa_kode;
    ...
    private void UpdateData()
    {
      ...
      try
      {
        purDataSet.pur_wrdetail[0].jasa_kode = HdKdJasa.Value;
    ...
    protected void GridSupplier_NeedDataSource(object source, GridNeedDataSourceEventArgs e)
    {

    }

    protected void GridReqJasa_ItemDataBound(object sender, GridItemEventArgs e)
    {
    ...
    protected void GridCekHarga_ItemCommand(object source, GridCommandEventArgs e)
    {
      if (e.CommandName == "RowClick")
      {
        ...
        PnlBrowseHargaPopupExtender.Hide();
      }    
    }

    protected void BtnCekHistoryHarga_Click(object sender, EventArgs e)
    {
      PnlBrowseHargaPopupExtender.Show();
    }
