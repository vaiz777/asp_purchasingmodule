<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Input.aspx.cs" Inherits="ManagementSystem.Purchasing.WorkRequest.NonProject.Work_Order.Input" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
  <title>Input Work Order - Purchasing | PT Tri Ratna Diesel Indonesia</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
          ...
          <asp:Panel ID="PnlInputPO1" runat="server" GroupingText="Input Item WO">
            <table>
                ...
                <td>
                  <table>
                    <tr>
                      ...
                      <td>
                        <asp:Button ID="Pnl1BtnBrowseJasa" runat="server" Text="..." onclick="Pnl1BtnBrowseJasa_Click" />
                      </td>
                    </tr>
                  </table>
                </td>
              ...
              <tr>
                ...
                <td class="tableFieldHeader"></td>
                <td>
                  <telerik:RadNumericTextBox ID="Pnl1RadNmrcTxtTotal" Runat="server" NumberFormat-DecimalDigits="2" />
                </td>           
              </tr>
              <tr>
                <td></td>
                ...
                <asp:Panel ID="PnlKurs" runat="server" Visible="false">
                  ...
                  <td class="tableFieldHeader">:</td>
                  <td>
                    <telerik:RadNumericTextBox ID="Pnl1RadNmrcTxtKurs" Runat="server" />
                  </td>
                </asp:Panel>
                <td style="width:20px"></td>
                <td></td>
            ...
            <table>
              <tr>
                ...
                <td class="tableFieldHeader">
                  <telerik:RadDatePicker ID="RDateTanggalWO" runat="server" 
                    Culture="Indonesian (Indonesia)" >
  ...
  <asp:ObjectDataSource ID="WODetailDataSource" runat="server" 
    ...
    <SelectParameters>
      <asp:ControlParameter ControlID="Pnl1HdIdWO" DefaultValue="0" Name="woId" 
        ...
        <div style="padding:10px;">
          <%--<table>
            <tr>
              ...
              <td class="tableFieldHeader">:</td>
              <td>
                <asp:TextBox ID="PnlWRTxtKataKunci" runat="server" CssClass="textbox_default"></asp:TextBox>
              </td>
              <td style="width:15px"></td>
              <td>
                <asp:Button ID="PnlWRBtnSerach" runat="server" Text="Cari" onclick="PnlWRBtnSerach_Click"  />
              </td>
            </tr>
          </table><br />--%>
  ...
  <asp:UpdatePanel ID="UpdatePanel4" runat="server">
    <ContentTemplate>
      ...
      <asp:Panel ID="PnlBrowseJasa" runat="server" Width="75%" CssClass="modalPopup" >
      <div style="padding: 5px">
        ...
        <div style="padding:10px;">
          <telerik:RadGrid ID="GridJasa" runat="server" AllowPaging="True" 
            ...
            onitemcommand="GridJasa_ItemCommand" ondatabound="GridJasa_DataBound" 
            onitemdatabound="GridJasa_ItemDataBound" 
