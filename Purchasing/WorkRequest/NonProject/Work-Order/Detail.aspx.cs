...
namespace ManagementSystem.Purchasing.WorkRequest.NonProject.Work_Order
{
  public partial class Detail : System.Web.UI.Page
  {
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      LblTglPelaksanaan.Text = purDataSet.vpur_wo01[0].tglpenyelesaian.ToShortDateString();
      ...
      LblUnitKerja.Text = purDataSet.vpur_wo01[0].unitkerja;

      if (LblUnitKerja.Text == "SHIPYARD")
      {
        LblTitle.Text = "Detail Work Order (Non Project)";
      }
      else
      {
        LblTitle.Text = "Detail Work Order";
      }
